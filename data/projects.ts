...
export const featuredProject: Project = {
  ...
  imageUrl: '/factor.png',
  skills: [
    'React Native', 'Python (Django)', 'PostgreSQL', 'Docker', 'Git',
    'CI/CD', 'AWS ECR', 'AWS ECS', 'AWS RDS',
  ],
...
export const otherProjects: Project[] = [
  ...
  },
  {
    title: 'ERP',
    description:
      'A multi-tenant ERP system for financial management and event organization. Role-based access control, accounts payable/receivable, cost center allocation, and automated PDF report generation.',
    imageUrl: '/erp.png',
