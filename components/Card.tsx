...
const Card = ({ title, description, imageUrl, skills, githubUrl }: { title: string, description: string, imageUrl: string, skills: string[], githubUrl: string }) => {
  return (
    <div className="card-container flex relative">
      <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-md">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-gray-700 text-base mb-4">{description} <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-700"> Learn more </a></p>
